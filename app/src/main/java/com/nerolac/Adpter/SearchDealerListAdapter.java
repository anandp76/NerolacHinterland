...
public class SearchDealerListAdapter extends BaseAdapter implements Filterable {
    ...
    public static ArrayList<String> mListItemsFilter = new ArrayList<>();

    Activity context;
    int ads = 0;
    ItemFilter mFilter;
    public SearchDealerListAdapter(Activity context, ArrayList<String> mListItems) {
    ...
    private class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final List<String> list = mListItems;
            int count = list.size();
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            mListItemsFilter = (ArrayList<String>) results.values;
