...
public class AnajMandiListAdapter extends BaseAdapter {

    private ArrayList<String> mListItems = new ArrayList<>();
    Activity context;
    int ads = 0;

    public AnajMandiListAdapter(Activity context, ArrayList<String> mListItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.activity_anajmandi_list_item, null);
