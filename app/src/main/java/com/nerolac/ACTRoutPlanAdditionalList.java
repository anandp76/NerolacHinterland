...
public class ACTRoutPlanAdditionalList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTranceprent(ACTRoutPlanAdditionalList.this,R.color.white);
        queue = Volley.newRequestQueue(ACTRoutPlanAdditionalList.this);
        database = new Database(ACTRoutPlanAdditionalList.this);
        ...
        mListItemN.clear();
        showProgress(ACTRoutPlanAdditionalList.this);
        mFunGetMataData1();
        retailerListAdapter = new MyPlanListAdapter(ACTRoutPlanAdditionalList.this,mListItemN);
        ...
        mSpinnerTehsil.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                ArrayAdapter arrayAdapterBlock  = new ArrayAdapter(ACTRoutPlanAdditionalList.this,android.R.layout.simple_spinner_item,mListBlock.toArray(new String[mListBlock.size()]));
        ...
        mListTehsil.clear();
        mListBlock.clear();
        mListTehsil = database.GT_RAW_LOCATION_TEHSIL(TBL_USER_ID,PreferenceManager.getNEROUSERID(ACTRoutPlanAdditionalList.this));
        mListTehsil.add(0,"ALL TEHSIL");

        ArrayAdapter arrayAdapterTehsil  = new ArrayAdapter(ACTRoutPlanAdditionalList.this,android.R.layout.simple_spinner_item,mListTehsil.toArray(new String[mListTehsil.size()]));
        ...
        ArrayAdapter arrayAdapterBlock  = new ArrayAdapter(ACTRoutPlanAdditionalList.this,android.R.layout.simple_spinner_item,mStrBlock);
        arrayAdapterBlock.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        mSpinnerBlock.setAdapter(arrayAdapterBlock);
     ...
     void mFunGetMataData1() {
        StringRequest strRequest = new StringRequest(Request.Method.POST,BaseUrl+"travelAdditional",
                        ...
                        try {
                            ...
                            if (mStrStatus.equals("200")) {
                                if (response.has("data")) {
                                    ...
                                    mShowAlert("No record found!!", ACTRoutPlanAdditionalList.this);
                                }
                                ...
                                mShowAlert(getResources().getString(R.string.Something), ACTRoutPlanAdditionalList.this);
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        hidePDialog();
                        mShowAlert(getString(R.string.Something), ACTRoutPlanAdditionalList.this);
                    }
                }) {
            @Override
            public Map<String, String> getHeaders() throws AuthFailureError {
                Map<String, String> params = new HashMap<String, String>();
                params.put("Authorization", PreferenceManager.getNEROTOKEN(ACTRoutPlanAdditionalList.this));
                return params;
            }
            @Override
            protected Map<String, String> getParams() {
                Map<String, String> params = new HashMap<String, String>();
                params.put("user_id",PreferenceManager.getNEROUSERID(ACTRoutPlanAdditionalList.this));
