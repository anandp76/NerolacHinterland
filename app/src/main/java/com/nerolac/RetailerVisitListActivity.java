...
public class RetailerVisitListActivity extends Activity {
    ...
    ImageView mImgAddNew,update_location;
        ...
        switch (requestCode) {
            ...
            case REQUEST_IMAGE_CAPTURE:
                ...
                try {
                    ...
                    long_shot_base64 = getStringImage(bitmap);
...
//                    }
                    ...
                    public void onResponse(String str) {
                        ...
                        try {
                            ...
                            if (mStrStatus.equals("200")) {
                                Boolean updateBool = response.getBoolean("update");
                                Integer fld_loc_update = response.getInt("fld_loc_update");
                                if(!updateBool && fld_loc_update !=1) {
    ...
    private void alertforLocationmessage() {

        LayoutInflater inflater = (LayoutInflater)
                getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View layout = inflater.inflate(R.layout.popfor_locationlayout,
                null);
        ...
        yes_text_popup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    if(PreferenceManager.getNEROLAT(mActivity) !="0.0" || PreferenceManager.getNEROLAT(mActivity) !="0") {
                        alertDialog1.dismiss();
                        showProgress(mActivity);
                        updateRetailerLocation();
                    }else{
                        mShowAlert("P lease turn on Gps first! Or update your gps location ",mActivity);
                    }
    ...
    public void updateRetailerLocation() {
        mListItem = new ArrayList<>();
        StringRequest strRequest = new StringRequest(Request.Method.POST,BaseUrl+"updateRetailerLocation",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String str) {
                        hidePDialog();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("lat",PreferenceManager.getNEROLAT(mActivity));
                params.put("long",PreferenceManager.getNEROLONG(mActivity));
