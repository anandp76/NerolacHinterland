...
public class ACTEditOrderSummry extends Activity {
    Spinner mSpinnerScheme;
    Spinner mSpinnerDistributor;
    Spinner mSpinnerBlock;
    public RecyclerView mListView;
    public static ACTEditOrderSummry instance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTranceprent(ACTEditOrderSummry.this, R.color.white);
        ...
        instance = ACTEditOrderSummry.this;
        ...
        mActivity = this;
        queue = Volley.newRequestQueue(ACTEditOrderSummry.this);
        mFunGetMataData1();
        database = new Database(ACTEditOrderSummry.this);
        mListItem = database.GT_Updatetocart(retailerId);
        retailerListAdapter = new AddToCartAdapter(ACTEditOrderSummry.this,mListItem,retailerId);
        ...
        addmore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < retailerListAdapter.ShopAreaSqFt_list.size(); i++) {
                    ...
                    database.UP_RAW_RMD_updatetocart(retailers,retailerId);

                }
                Intent intent = new Intent(ACTEditOrderSummry.this, ACTProductList.class);
                ...
                if(retailerListAdapter.ShopAreaSqFt_list.size()>0){
                    ...
                    if(checkamount){
                        if(!totalamount.getText().toString().trim().equals("Rs. 0")){
                            showProgress(ACTEditOrderSummry.this);
...
//                                    retailers.setTbBlock(mStrBlock);
    ...
    private void alertcofirmation() {
        ...
        yes_text_popup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                alertDialog.dismiss();
                database.deleteupdatedorder(retailerId);
                finish();
    ...
    public void mpushorder() {
        StringRequest strRequest = new StringRequest(Request.Method.POST,BaseUrl+"addorder",
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("created_by","0");
                params.put("order_date", CommonData.getTimeformatWithoutTime());
                params.put("fld_lat", PreferenceManager.getNEROLAT(ACTEditOrderSummry.this));
                params.put("fld_long", PreferenceManager.getNEROLONG(ACTEditOrderSummry.this));
